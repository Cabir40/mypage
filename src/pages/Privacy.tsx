...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      <Header />
      <SEO title="Privacy Policy — Cabir Çelik" description="How Cabir Çelik's site collects, uses, and protects visitor information." path="/privacy" />
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground">
              At Cabir Çelik, we take your privacy seriously. This Privacy Policy explains how we collect, 
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-4">
              Email: privacy@cabircelik.com<br />
